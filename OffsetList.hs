...
-- OFFSET LIST                      offsetList(l,f)
-- DEFINISI DAN SPESIFIKASI      
offsetList :: [Int] -> (Int -> Int) -> [Int]
{- menerima masukan sebuah list of integer yang melakukan “offset” atau perubahan nilai terhadap elemen list sesuai dengan aturan tertentu (yang ditentukan oleh sebuah fungsi offset) dan menghasilkan list baru dengan elemen hasil offset -}
plus2 :: Int -> Int
